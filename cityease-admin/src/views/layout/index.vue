...
import { Platform, DataLine, Tools, Money, House, Fold, Expand, ArrowDown, User, Connection, Setting, Trophy } from '@element-plus/icons-vue'
...
.content {
  padding: 12px;
  overflow: auto;
  background: radial-gradient(circle at 20% 20%, rgba(24, 144, 255, 0.05), transparent 40%),
  radial-gradient(circle at 80% 0%, rgba(34, 197, 94, 0.04), transparent 35%),
  #0b1220;
}
